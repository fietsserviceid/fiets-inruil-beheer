...
let GHD={owner:'fietsserviceid',repo:'fiets-inruil-beheer',path:'docs/dealers.json',branch:'main'}; // dealers.json opslag
function openSettings(){const d=document.getElementById('settingsDialog');
 document.getElementById('ghOwner').value=GH.owner;document.getElementById('ghRepo').value=GH.repo;document.getElementById('ghPath').value=GH.path;document.getElementById('ghBranch').value=GH.branch;
 document.getElementById('ghDOwner').value=GHD.owner;document.getElementById('ghDRepo').value=GHD.repo;document.getElementById('ghDPath').value=GHD.path;document.getElementById('ghDBranch').value=GHD.branch;
 document.getElementById('ghToken').value=sessionStorage.getItem('ghToken')||''; d.showModal(); }
function closeSettings(){document.getElementById('settingsDialog').close();}
function saveSettings(){GH.owner=document.getElementById('ghOwner').value.trim()||GH.owner;GH.repo=document.getElementById('ghRepo').value.trim()||GH.repo;GH.path=document.getElementById('ghPath').value.trim()||GH.path;GH.branch=document.getElementById('ghBranch').value.trim()||GH.branch;
 GHD.owner=document.getElementById('ghDOwner').value.trim()||GHD.owner;GHD.repo=document.getElementById('ghDRepo').value.trim()||GHD.repo;GHD.path=document.getElementById('ghDPath').value.trim()||GHD.path;GHD.branch=document.getElementById('ghDBranch').value.trim()||GHD.branch;
